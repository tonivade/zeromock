...
public class Requests {
  ...
  public static HttpRequest get(String path) {
    return new HttpRequest(GET, new Path(path), null, HttpHeaders.empty(), emptyMap());
  }

  public static HttpRequest post(String path) {
    return new HttpRequest(POST, new Path(path), null, HttpHeaders.empty(), emptyMap());
  }

  public static HttpRequest put(String path) {
    return new HttpRequest(PUT, new Path(path), null, HttpHeaders.empty(), emptyMap());
  }

  public static HttpRequest delete(String path) {
    return new HttpRequest(DELETE, new Path(path), null, HttpHeaders.empty(), emptyMap());
  }

  public static HttpRequest patch(String path) {
    return new HttpRequest(PATCH, new Path(path), null, HttpHeaders.empty(), emptyMap());
  }
}
